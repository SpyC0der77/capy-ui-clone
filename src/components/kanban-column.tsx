  ...
  return (
    <div
      className={cn(
        ...
        isOver && "ring-2 ring-primary/50 ring-offset-2 ring-offset-background bg-primary/5 border-primary/30 shadow-lg"
      )}
    >
        ...
        >
          {count === 0 ? (
            <div className="text-center space-y-1.5">
              <div className="text-muted-foreground/40 text-sm font-medium">No tasks</div>
              <div className="text-muted-foreground/30 text-xs">Drop tasks here</div>
            </div>
          ) : (
            children
          )}
